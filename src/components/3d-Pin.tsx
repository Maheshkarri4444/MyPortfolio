...
const PinPerspective = ({
  ...
  return (
    <motion.div className="pointer-events-none w-72 h-60 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[40] transition duration-500">
      <div className="inset-0 flex-none w-full h-full -mt-7">
        <div className="absolute inset-x-0 top-0 flex justify-center">
          <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10">
            <span className="relative z-20 text-slate-100 text-xs font-bold inline-block py-0.5">
        ...
        >
          {[0, 2, 4].map((delay) => (
            <motion.div
              ...
              className="absolute left-1/2 top-1/2 h-36 w-36 rounded-[50%] bg-sky-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"
            />
          ))}
        </div>
